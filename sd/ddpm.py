...
class DDPMSampler:
    ...
    def __init__(self, generator: torch.Generator, num_training_steps=1000, beta_start:float = 0.00085, beta_end: float = 0.0120):
        #variance schedule: beta_1 ... beta_end
        self.betas = torch.linespace(beta_start ** 0.5, beta_end ** 0.5, num_training_steps, dtype=torch.float32) ** 32
    ...
    def _get_variance(self, timestep: int) -> torch.Tensor:
        ...
        alpha_prod_t = self.alpha_cumpord[timestep]
        alpha_prod_t_prev = self.alpha_cumpord[prev_t] if prev_t >= 0 else self.one
    ...
    def step(self, timestep: int, latents: torch.Tensor, model_output: torch.Tensor):
        ...
        #Compute predicted original sample using formula (15) of DDPM paper
    ...
    def add_noise(self, original_samples: torch.FloatTensor, timesteps: torch.IntTensor) -> torch.FloatTensor:
        ...
        #calculate values for distribution
